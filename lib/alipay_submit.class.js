...
AlipaySubmit.prototype.buildRequestForm = function(para_temp, method, button_name) {
    ...
    var sHtml = "<form id='alipaysubmit' name='alipaysubmit' action='" + this.alipay_gateway_new + "_input_charset=" + this.alipay_config['input_charset'].toLowerCase().trim() + "' method='" + method + "'>";
