...
alipay.on('verify_fail', function(){console.log('emit verify_fail')})
	.on('create_direct_pay_by_user_trade_finished', function(out_trade_no, trade_no){console.log('create_direct_pay_by_user_trade_finished',out_trade_no, trade_no);})
	.on('create_direct_pay_by_user_trade_success', function(out_trade_no, trade_no){console.log('create_direct_pay_by_user_trade_success',out_trade_no, trade_no);})	
	.on('refund_fastpay_by_platform_pwd_success', function(batch_no, success_num, result_details){console.log('refund_fastpay_by_platform_pwd_success',batch_no, success_num, result_details);})
